...
class BangunDatar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val iconPersegi: ImageButton = findViewById (R.id.persegi)
        iconPersegi.setOnClickListener {
            val intent = Intent(this, Persegi::class.java)
            startActivity(intent)
        }

        val iconlingkaran: ImageButton = findViewById (R.id.lingkaran)
        iconlingkaran.setOnClickListener {
            val intent = Intent(this, Lingkaran::class.java)
            startActivity(intent)
        }

        val iconPersegipanjang: ImageButton = findViewById (R.id.persegipanjang)
        iconPersegipanjang.setOnClickListener {
            val intent = Intent(this, PersegiPanjang::class.java)
            startActivity(intent)
        }

        val iconSegitiga: ImageButton = findViewById (R.id.segitiga)
        iconSegitiga.setOnClickListener {
            val intent = Intent(this, Segitiga::class.java)
            startActivity(intent)
        }
