...
class Lingkaran : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputPanjangJariJari.setOnKeyListener { v, keyCode, event ->
