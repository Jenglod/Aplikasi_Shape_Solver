    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonHitung.setOnClickListener{
            ...
            if (sisi.isEmpty() ) {
                ...
                hasilLuas.text = "Luas: $luas cm²"

            }
        }

        inputPanjangSisi.setOnKeyListener { v, keyCode, event ->
